            ...
            <div className="w-full flex gap-3 items-start">
              ...
              <div className="w-full pt-2">
                <div className="w-full flex gap-3 items-center">
                  ...
                  <div className=" w-full p-3 text-xs bg-purple-100 text-gray-800 rounded-md h-fit ">
                    To add a student in the system the student must place his /
                    her finger print on the finger print sensor ,make sure that
                    the finger print has been loaded before continueing with the
                    registration process
                  </div>
                </div>
                <div className=" w-full  grid grid-cols-2 gap-x-8 gap-y-6 px-4 place-items-end">
                  ...
                  <div className="relative z-0 w-full group">
                    ...
                    <Select
                      className="basic-single focus:border-purple-300 text-[12px]"
