                    ...
                    <div className="flex mb-4 w-fit  ">
                      {!selectedImageF && (
                        ...
                        >
                          ...
                          />
                          <p className=" text-[10px] font-semibold p-3 w-full  text-white absolute  bottom-0  left-0  bg-purple-500 bg-opacity-50 backdrop-blur-sm h-fit transition-all duration-300 group-hover:-translate-y-[100%]  ">
